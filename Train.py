...
from lib.networks import PVT_Dense_Decoder
...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            # ---- recording loss ----
            if rate == 1:
                loss_P3_record.update(loss_P2.data, opt.batchsize)
        # ---- train visualization ----
    ...
    torch.save(model.state_dict(), save_path +str(epoch)+ 'Polyp-Dense.pth')
